...
#define STATE_ADVENTCAL_TURNTODELIVER1 3
#define STATE_ADVENTCAL_TURNTODELIVER2 4
#define STATE_ADVENTCAL_TURNTODELIVER3 5
#define STATE_ADVENTCAL_DELIVER 6
#define STATE_ADVENTCAL_FLAPOPEN 7
#define STATE_ADVENTCAL_MOVEBACK 8
#define STATE_ADVENTCAL_TURNTOSTARTPOS 9
...
void bot_adventcal_behaviour(Behaviour_t * data) {
	...
	case STATE_ADVENTCAL_FLAPCLOSE:
		...
		adventcal_state = STATE_ADVENTCAL_TURNTODELIVER1;
		LOG_DEBUG("STATE_ADVENTCAL_FLAPCLOSE_END");
		break;
	case STATE_ADVENTCAL_TURNTODELIVER1:
		LOG_DEBUG("STATE_ADVENTCAL_TURNTODELIVER1_BEGIN");
		bot_turn(data, 90);
		adventcal_state = STATE_ADVENTCAL_TURNTODELIVER2;
		LOG_DEBUG("STATE_ADVENTCAL_TURNTODELIVER1_END");
		break;
	case STATE_ADVENTCAL_TURNTODELIVER2:
		LOG_DEBUG("STATE_ADVENTCAL_TURNTODELIVER2_BEGIN");
		bot_goto_dist(data, 30, 1);
		adventcal_state = STATE_ADVENTCAL_TURNTODELIVER3;
		LOG_DEBUG("STATE_ADVENTCAL_TURNTODELIVER2_END");
		break;
	case STATE_ADVENTCAL_TURNTODELIVER3:
		LOG_DEBUG("STATE_ADVENTCAL_TURNTODELIVER3_BEGIN");
		bot_turn(data, 90);
		adventcal_state = STATE_ADVENTCAL_DELIVER;
		LOG_DEBUG("STATE_ADVENTCAL_TURNTODELIVER3_END");
		break;
