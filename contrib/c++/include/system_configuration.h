...
#define __UCLIBCXX_EXPAND_STREAMBUF_CHAR__
#define __UCLIBCXX_EXPAND_SSTREAM_CHAR__
#define __UCLIBCXX_EXPAND_OSTREAM_CHAR__
#define __UCLIBCXX_EXPAND_ISTREAM_CHAR__
#define __UCLIBCXX_EXPAND_VECTOR_BASIC__
